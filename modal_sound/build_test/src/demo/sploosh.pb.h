...
#ifndef PROTOBUF_sploosh_2eproto_INCLUDED
#define PROTOBUF_sploosh_2eproto_INCLUDED
...
namespace google {
namespace protobuf {
template<> ::sploosh::Complexd* Arena::Create< ::sploosh::Complexd>(Arena*);
template<> ::sploosh::FMMoments* Arena::Create< ::sploosh::FMMoments>(Arena*);
template<> ::sploosh::ModalMoments* Arena::Create< ::sploosh::ModalMoments>(Arena*);
template<> ::sploosh::Vector3d* Arena::Create< ::sploosh::Vector3d>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace sploosh {
...
class Vector3d : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:sploosh.Vector3d) */ {
 public:
  ...
  inline Vector3d* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<Vector3d>(NULL);
  }

  Vector3d* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<Vector3d>(arena);
  }
...
class Complexd : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:sploosh.Complexd) */ {
 public:
  ...
  inline Complexd* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<Complexd>(NULL);
  }

  Complexd* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<Complexd>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
class FMMoments : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:sploosh.FMMoments) */ {
 public:
  ...
  inline FMMoments* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<FMMoments>(NULL);
  }

  FMMoments* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<FMMoments>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
class ModalMoments : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:sploosh.ModalMoments) */ {
 public:
  ...
  inline ModalMoments* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<ModalMoments>(NULL);
  }

  ModalMoments* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<ModalMoments>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
inline ::sploosh::Vector3d* FMMoments::mutable_center() {
  set_has_center();
  if (center_ == NULL) {
    center_ = ::google::protobuf::Arena::Create< ::sploosh::Vector3d >(
        GetArenaNoVirtual());
  }
...
#endif  // PROTOBUF_sploosh_2eproto_INCLUDED
