...
// @@protoc_insertion_point(message_clear_start:sploosh.FMMoments)
  ...
  if (cached_has_bits & 3u) {
    if (cached_has_bits & 0x00000001u) {
      ...
      mfile_.UnsafeMutablePointer()->clear();
    }
    if (cached_has_bits & 0x00000002u) {
  ...
  if (cached_has_bits & 0x00000002u) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        3, *center_, deterministic, target);
  }
...
void ModalMoments::InternalSwap(ModalMoments* other) {
  using std::swap;
  CastToBase(&moment_)->InternalSwap(CastToBase(&other->moment_));
  swap(_has_bits_[0], other->_has_bits_[0]);
  _internal_metadata_.Swap(&other->_internal_metadata_);
  swap(_cached_size_, other->_cached_size_);
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::sploosh::Vector3d* Arena::Create< ::sploosh::Vector3d >(Arena* arena) {
  return Arena::CreateInternal< ::sploosh::Vector3d >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::sploosh::Complexd* Arena::Create< ::sploosh::Complexd >(Arena* arena) {
  return Arena::CreateInternal< ::sploosh::Complexd >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::sploosh::FMMoments* Arena::Create< ::sploosh::FMMoments >(Arena* arena) {
  return Arena::CreateInternal< ::sploosh::FMMoments >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::sploosh::ModalMoments* Arena::Create< ::sploosh::ModalMoments >(Arena* arena) {
  return Arena::CreateInternal< ::sploosh::ModalMoments >(arena);
}
}  // namespace protobuf
}  // namespace google
